...
class Demo {
  ...
  public static void main(String[] args) {
    ...
    String hash = GeoHash36
      .encode(coordinates, GeoHash36.DEFAULT_NUM_CHARACTERS);

    System.out
      .printf("Geohash-36 of %s is: %s\n", coordinates.toString(), hash);
    ...
    System.out
      .printf("%s\t", GeoHash36.getNeighbor(hash, NeighborsDir.SOUTHWEST));
